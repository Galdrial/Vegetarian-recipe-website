...
function Card({src, alt, title, description, span }: {src?: string, alt?: string, title?: string, description?: string, span?: string}) { 
  return (
    ...
    <div className={`${span} bg-green-300 p-6 rounded-3xl flex flex-col items-center text-center hover:scale-[1.02] transition-transform duration-300 shadow-black/50 shadow-xl`}>
      <a href="/">
